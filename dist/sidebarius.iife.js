var Sidebarius = (function () {
    ...
    class Sidebarius {
        ["a" /* Prop.Callback */];
        ["b" /* Prop.ColliderHeight */];
        ["c" /* Prop.ColliderTop */];
        ["d" /* Prop.Container */];
        ["e" /* Prop.ContainerBottom */];
        ["f" /* Prop.ContainerHeight */];
        ["g" /* Prop.ContainerInner */];
        ["h" /* Prop.ContainerLeft */];
        ["i" /* Prop.ContainerTop */];
        ["j" /* Prop.ContainerWidth */];
        ["k" /* Prop.Event */];
        ["l" /* Prop.IsRunningRequest */];
        ["o" /* Prop.ListOfRules */];
        ["p" /* Prop.MaxBottomWithTranslateY */];
        ["q" /* Prop.MaxTopWithTranslateY */];
        ["r" /* Prop.MaxTranslateY */];
        ["s" /* Prop.PrevColliderTop */];
        ["t" /* Prop.PrevContainerLeft */];
        ["u" /* Prop.PrevContainerTop */];
        ["v" /* Prop.PrevContainerWidth */];
        ["w" /* Prop.PrevElementHeight */];
        ["x" /* Prop.PrevSpaceBottom */];
        ["y" /* Prop.PrevSpaceTop */];
        ["z" /* Prop.PrevState */];
        ["A" /* Prop.PrevStrategy */];
        ["B" /* Prop.PrevViewportScrollX */];
        ["C" /* Prop.PrevViewportScrollY */];
        ["D" /* Prop.ResizeObserver */];
        ["E" /* Prop.SpaceBottom */];
        ["F" /* Prop.SpaceTop */];
        ["G" /* Prop.Strategy */];
        ["H" /* Prop.TranslateY */];
...
//# sourceMappingURL=sidebarius.iife.js.map
